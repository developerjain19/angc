...
<body>
    ...
    <div class="layout-wrapper landing">
        ...
        <section class="section pb-0 hero-section" id="login" style="background-image: url('<?= base_url() ?>assets/Rect Light.svg');background-size: cover;
                                ...
                                <div class="row justify-content-center g-0">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-lg-5 p-4">
                                            <div>
                                                <h1 class="display-6 fw-semibold mb-3 lh-base text-center"> <span class="text-primary">User Login </span></h1>
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <form class="form-horizontal" method="POST" action="<?php echo base_url('Admin/leadlogin'); ?>">
