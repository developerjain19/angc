              ...
              <div class="row">
                <div class="col-xxl-12">
                  <div class="row">
                    ...
                    <div class="col-xl-4">
                      <a href="<?= base_url(); ?>leads?status=New">
                        <div class="card card-animate">
                          <div class="card-body">
                            <div class="d-flex align-items-center">
                              <div class="avatar-sm flex-shrink-0">
                    ...
                    <div class="col-xl-4">
                      <a href="<?= base_url(); ?>leads?status=Verified">
                        <div class="card card-animate">
                          <div class="card-body">
                            <div class="d-flex align-items-center">
                              <div class="avatar-sm flex-shrink-0">
                    ...
                    <div class="col-xl-4">
                      <a href="<?= base_url(); ?>leads?status=Reject">
                        <div class="card card-animate">
                          <div class="card-body">
                            <div class="d-flex align-items-center">
                              <div class="avatar-sm flex-shrink-0">
                              ...
                              <div class="flex-grow-1 overflow-hidden ms-3">
                                ...
                                <p class="text-muted mb-0">All Reject Leads</p>
                              </div>
                            </div>
                          </div><!-- end card body -->
                        </div>
                            ...
                            <div class="d-flex align-items-center">
                              ...
                              <div class="flex-grow-1 overflow-hidden ms-3">
                                <p class="text-uppercase fw-medium text-muted text-truncate mb-3">
                                  Reject Leads</p>
                                <div class="d-flex align-items-center mb-3">
                                  <h4 class="fs-4 flex-grow-1 mb-0"><span class="counter-value" data-target="168"><?= $reject ?></span></h4>
